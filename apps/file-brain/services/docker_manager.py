...
class DockerManager:
    ...
    def __init__(self, compose_file_path: Optional[str] = None):
        ...
        if compose_file_path:
            ...
            # Default to docker-compose.yml in the app directory
            app_dir = Path(__file__).parent.parent
            self.compose_file = app_dir / "docker-compose.yml"
    ...
    async def get_services_status(self) -> Dict[str, any]:
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                # Check Tika
                tika_healthy = await check_service_health("tika", "http://localhost:9998/version")
